...
class Account
{
    ...
    #[Id, Column(name: 'account_id', type: Types::INTEGER)]
    #[GeneratedValue(strategy: 'IDENTITY')]
    private ?int $accountId = null;

    #[Column(name: 'external_account_id', type: Types::STRING, length: 32, nullable: true)]
    private ?string $externalAccountId = null;

    #[Column(name: 'bank_id', type: Types::INTEGER)]
    private int $bankId;
    ...
    #[Column(name: 'overdraft_facility', type: Types::INTEGER)]
