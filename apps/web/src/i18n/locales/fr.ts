...
export default {
  ...
  errors: {
    ...
    opening_operation_locked: "L'opération d'ouverture ne peut pas être modifiée.",
    transfer_account_not_active: "Le compte de virement n'est pas actif.",
    transfer_currency_mismatch: 'Le compte de virement doit avoir la même devise.',
    transfer_account_invalid: 'Compte de virement invalide.',
    transfer_same_account: 'Vous ne pouvez pas faire un virement vers le même compte.',
    payment_method_invalid: "Ce moyen de paiement ne correspond pas au type de l'opération.",
    category_invalid: "Cette catégorie ne correspond pas au type de l'opération.",
    step_up_required: "Veuillez d'abord confirmer avec votre passkey.",
    step_up_failed: 'La confirmation par passkey a échoué. Veuillez réessayer.',
    passkey_registration_failed: "L'enregistrement de la passkey a échoué.",
    passkey_sign_in_failed: 'La connexion par passkey a échoué.',
    signup_link_invalid: "Ce lien d'inscription est invalide ou a expiré.",
    email_change_link_invalid: "Ce lien de changement d'e-mail a expiré ou a déjà été utilisé.",
    last_passkey:
      "C'est votre dernière passkey — vous ne pouvez pas la supprimer, sinon vous seriez définitivement verrouillé(e) hors de votre compte.",
    quota_exceeded: 'Vous pouvez avoir au maximum {limit} {kind}.',
    kinds: {
      banks: 'banques',
      accounts: 'comptes',
      schedulers: 'échéanciers',
      reports: 'rapports',
    },
  },
  language: {
